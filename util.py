...
class AspectRatio:
    ...
    def ar_size(self, is_width, aspect, size):
        aspect_ratios = (self.aspect_ratios_num[self.aspect_ratios_label.index(aspect)])
    ...
    def run(self, size, aspect, standard, batch_size):
        
        is_width = standard == "width"
        result_dimension = self.ar_size(is_width, aspect, size)
